    ...
    return (
        <div className="flex flex-col gap-4 w-full lg:w-5/6">
            {speakers.map((speaker) => (
                ...
                >
                    {/* Speaker Image */}
                    <div className="flex-shrink-0 w-24 h-24 lg:w-28 lg:h-28 relative">
                        <Image
                            src={speaker.image}
                    ...
                    <div className="flex flex-col flex-grow pl-2 lg:pl-4">
                        <h4 className="text-md md:text-xl lg:text-2xl font-bold">{speaker.topic}</h4>
                        <p className="text-sm md:text-md lg:text-lg text-neutral">{speaker.name}</p>
                    </div>
