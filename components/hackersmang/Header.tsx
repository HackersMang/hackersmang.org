...
export default function Header() {
  ...
  return (
    <>
      <header className="m-2 mt-2 lg:m-6 lg:mb-1 p-0 outline outline-[1.5px] fixed top-0 left-0 right-0 z-50 bg-grainy">
        <div className="flex items-center justify-between h-16">
          ...
          {/* Menu Button */}
          <div className="h-full w-20 lg:w-36 flex justify-center items-center outline outline-[1.5px] text-sm p-0">
      ...
      {/* Sliding Menu */}
      <div
        className={`fixed inset-0 bg-grainy transform ${
      ...
      >
        <div className="flex flex-col items-center justify-center h-full space-y-8 text-3xl">
          <Link href="/ai-techverse" className="hover:text-gray-300 transition-colors">
            <HyperText text="AI TECHVERSE" className="outfit-bold text-white cursor-pointer" />
          </Link>
          <Link href="/2024-november" className="hover:text-gray-300 transition-colors">
            <HyperText text="2024 November" className="outfit-bold text-white cursor-pointer" />
          </Link>
        </div>
      </div>
    </>
