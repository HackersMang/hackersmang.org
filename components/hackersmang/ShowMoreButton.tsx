...
export default function ShowMoreButton() {
    ...
    return (
        <>
            <button onClick={toggleMenu} className='flex flex-row space-x-3 justify-center text-center outline outline-[1.5px] outline-[#2b2828] p-4 text-neutral hover:text-secondary hover:bg-[#2b2828]' >
            ...
            >
                <button onClick={toggleMenu} className='absolute mt-2 right-6 flex flex-row space-x-3 justify-center text-center outline outline-[1.5px] outline-[#2b2828] p-4 text-neutral hover:text-secondary' >
