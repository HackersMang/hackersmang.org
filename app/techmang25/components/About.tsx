...
const About = () => {
    return (
        <div className="nav-link-outline w-full flex flex-col items-center justify-center text-center mt-2 shadow-lg">
            <div className="p-4">
                ...
                <div className="p-6 shadow-md mt-4 nav-link-outline">
