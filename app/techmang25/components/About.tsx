...
const About = () => {
    return (
        <div className="nav-link-outline rounded-3xl w-full flex flex-col items-center justify-center text-center mt-6 shadow-lg">
            <div className="p-4">
                ...
                <div className="p-6 rounded-xl shadow-md mt-4">
                    <h4 className="text-md mb-4 text-[#d4e20b]">Past Events</h4>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="nav-link-outline p-4 rounded-lg shadow">
                            <p className="text-lg font-semibold">
                                <Link href="https://tdmjul18.eventbrite.com/" target="_blank" rel="noopener noreferrer" className="underline">2018 - I</Link>
                            </p>
                        </div>
                        <div className="nav-link-outline p-4 rounded-lg shadow">
                            <p className="text-lg font-semibold">
                                <Link href="https://techmang2.eventbrite.com/" target="_blank" rel="noopener noreferrer" className="underline">2018 - II</Link>
                            </p>
                        </div>
                        <div className="nav-link-outline p-4 rounded-lg shadow">
                            <p className="text-lg font-semibold">
                                <Link href="https://techmang3.eventbrite.com/" target="_blank" rel="noopener noreferrer" className="underline">2019</Link>
                            </p>
                        </div>
                        <div className="nav-link-outline p-4 rounded-lg shadow">
                            <p className="text-lg font-semibold">
                                <Link href="https://techmang24.eventbrite.com/" target="_blank" rel="noopener noreferrer" className="underline">2024</Link>
                            </p>
                        </div>
                    </div>
                </div>
